	...
	<div id="main" align="center">
		<form id="article">
			<div id="article-title">
				<span><textarea tabindex="1" maxlength="50" placeholder="添加标题" rows="1" id="title">${article.title}</textarea></span>
			</div>
			...
			<div id="article-content">
				<ul id="content-util">
					...
					<li><img src="../image/icon/pic.png" style="width:30px;height:30px;" alt="添加图片" ><input type="file" id="Img" name="images" multiple="multiple"/></li>
				</ul>
				<!--<span><textarea placeholder="写文章..." id="content"></textarea></span>-->
				<div id="content" contenteditable="true" data-text="写文章..." >${article.content}</div>
			</div><br/>
			...
			<span><input type="button" onclick="publishArticle('${article.id}')" id="publish" value="发布文章"></span>
		</form>
	</div>
</body>
